...
public class PolygonOptimizer : MonoBehaviour {
    ...
    void Start ()
    {
        ...
        GameObject globalPolygonOptimizer = GameObject.FindGameObjectWithTag("PolygonOptimizer"); //c;
        globalPolygonOptimizer.GetComponent<GlobalPolygonOptimizer>().addModel(transform);
